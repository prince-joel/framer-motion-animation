...
function App() {
  ...
  return (
    <div className="App">
      ...
      <motion.h1 animate={{ x: [0, 150, 50], opacity: 1, scale: 1 }} transition={{ duration: 5, delay: 0.3, ease: [0.5, 0.71, 1, 1.5]
      }}  whileHover={{ scale: 1.2 }}   initial={{ opacity: 0, scale: 0.5 }}     
      >Animation made easy with Framer Motion</motion.h1>

      <motion.div ref={carousel}  className="carousel" >
        <motion.div animate={{scale: [1, 1, 1, 2, 1],
      rotate: [10, 10, 100, 100, 360],
    }} drag="x" 
